...
from SaitamaRobot import (DEV_USERS, OWNER_ID, WORLD_GOVTOVT, ADMIRALS, WARLORDS, REVOLUTIONARIES,
                          dispatcher)
...
BLACKLISTWHITELIST = [OWNER_ID] + DEV_USERS + WORLD_GOVTOVT + REVOLUTIONARIES + ADMIRALS
...
def __user_info__(user_id):
    ...
    if user_id == dispatcher.bot.id:
        return ""
    if int(user_id) in WORLD_GOVTOVT + WARLORDS + REVOLUTIONARIES:
        return ""
    if is_blacklisted:
